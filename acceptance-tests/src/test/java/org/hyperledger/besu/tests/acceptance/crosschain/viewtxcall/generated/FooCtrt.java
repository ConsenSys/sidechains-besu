...
public class FooCtrt extends CrosschainContract {
    private static final String BINARY = "";
    ...
    public RemoteFunctionCall<TransactionReceipt> setPropertiesForBar2(BigInteger _bar2ChainId, String _bar2CtrtAddress) {
        final Function function = new Function(
                FUNC_SETPROPERTIESFORBAR2, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(_bar2ChainId), 
                new org.web3j.abi.datatypes.Address(160, _bar2CtrtAddress)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public byte[] setPropertiesForBar2_AsSignedCrosschainSubordinateTransaction(BigInteger _bar2ChainId, String _bar2CtrtAddress, final CrosschainContext crosschainContext) throws IOException {
        final Function function = new Function(
                FUNC_SETPROPERTIESFORBAR2, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(_bar2ChainId), 
                new org.web3j.abi.datatypes.Address(160, _bar2CtrtAddress)), 
    ...
    public RemoteFunctionCall<TransactionReceipt> setPropertiesForBar2_AsCrosschainTransaction(BigInteger _bar2ChainId, String _bar2CtrtAddress, final CrosschainContext crosschainContext) {
        final Function function = new Function(
                FUNC_SETPROPERTIESFORBAR2, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(_bar2ChainId), 
                new org.web3j.abi.datatypes.Address(160, _bar2CtrtAddress)), 
    ...
    public RemoteFunctionCall<BigInteger> tpFlag() {
        final Function function = new Function(FUNC_TPFLAG, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }

    public byte[] tpFlag_AsSignedCrosschainSubordinateView(final CrosschainContext crosschainContext) throws IOException {
        final Function function = new Function(FUNC_TPFLAG, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return createSignedSubordinateView(function, crosschainContext);
    ...
    public RemoteFunctionCall<BigInteger> tvFlag() {
        final Function function = new Function(FUNC_TVFLAG, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }

    public byte[] tvFlag_AsSignedCrosschainSubordinateView(final CrosschainContext crosschainContext) throws IOException {
        final Function function = new Function(FUNC_TVFLAG, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return createSignedSubordinateView(function, crosschainContext);
    ...
    public byte[] updateStateFromPure_AsSignedCrosschainSubordinateTransaction(final CrosschainContext crosschainContext) throws IOException {
        final Function function = new Function(
                FUNC_UPDATESTATEFROMPURE, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<TransactionReceipt> updateStateFromPure_AsCrosschainTransaction(final CrosschainContext crosschainContext) {
        final Function function = new Function(
                FUNC_UPDATESTATEFROMPURE, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public byte[] updateStateFromTxView_AsSignedCrosschainSubordinateTransaction(final CrosschainContext crosschainContext) throws IOException {
        final Function function = new Function(
                FUNC_UPDATESTATEFROMTXVIEW, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<TransactionReceipt> updateStateFromTxView_AsCrosschainTransaction(final CrosschainContext crosschainContext) {
        final Function function = new Function(
                FUNC_UPDATESTATEFROMTXVIEW, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public byte[] updateStateFromView_AsSignedCrosschainSubordinateTransaction(final CrosschainContext crosschainContext) throws IOException {
        final Function function = new Function(
                FUNC_UPDATESTATEFROMVIEW, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<TransactionReceipt> updateStateFromView_AsCrosschainTransaction(final CrosschainContext crosschainContext) {
        final Function function = new Function(
                FUNC_UPDATESTATEFROMVIEW, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
