...
//
//  public ThresholdSigning(final int myNodeNumber, final int threshold, final int totalNumberOfNodes) {
...
//  private Object sendPrivateMessage(final InterNodeMessages type, final ThresholdSigning destination)
//      throws Exception {
//    return sendPrivateMessage(type, destination, null);
//  }
//
//  private Object sendPrivateMessage(
//      final InterNodeMessages type, final ThresholdSigning destination, final Object data) throws Exception {
//    switch (type) {
