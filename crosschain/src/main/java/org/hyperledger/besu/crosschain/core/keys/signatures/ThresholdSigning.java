...
public class ThresholdSigning {
  ...
  //
  //  public ThresholdSigning(final int myNodeNumber, final int threshold, final int
  // totalNumberOfNodes) {
  ...
  //      final ThresholdSigning[] listOfNodes,
  //      final SimulatedThresholdKeyGenContractSingleKeyGen thesholdContract)
  //      throws Exception {
  ...
  //    for (ThresholdSigning node : this.listOfNodes) {
  //      if (node != this) {
  ...
  //   *
  //   * <p>That is, the public key is the point for X=0. Given equations y = a x^3 + b x^2 + c x +
  // d,
  ...
  //  private Object sendPrivateMessage(final InterNodeMessages type, final ThresholdSigning
  // destination)
  //      throws Exception {
  ...
  //      final InterNodeMessages type, final ThresholdSigning destination, final Object data)
  // throws Exception {
  //    switch (type) {
